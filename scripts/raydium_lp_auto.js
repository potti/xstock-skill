...
function loadKeypair(args) {
  const raw = args.secretFile ? fs.readFileSync(args.secretFile, "utf8") : process.env[args.secretEnv] || "";
  if (!raw) throw new Error("No secret provided: use --secret-file or --secret-env");
